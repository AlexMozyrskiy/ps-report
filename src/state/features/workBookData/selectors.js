...
export const calculateAllDataForTheReportOtstSheetSmartSelector = createSelector(
    ...
    otstData => {
        ...
        otstData.forEach(item => {                                          // для каждого объекта (строчки в excel)
            ...
            if (item["EXCLUDE"] === 0 && item["СТРЕЛКА"] === 0 && item["СТЕПЕНЬ"] === 2 && item["PR_PREDUPR"] === 1 && item["ОТСТУПЛЕНИЕ"] !== "Кривая" && item["ОТСТУПЛЕНИЕ"] !== "ПрУ") {
            ...
            if (item["EXCLUDE"] === 0 && item["СТРЕЛКА"] === 0 && item["СТЕПЕНЬ"] === 3 && item["ОТСТУПЛЕНИЕ"] !== "Кривая" && item["ОТСТУПЛЕНИЕ"] !== "ПрУ") {
                thirdDegrees.push({
                    "EXCLUDE": item["EXCLUDE"],
                    "KM": item["KM"],
                    "PR_PREDUPR": item["PR_PREDUPR"],
            ...
            if (item["EXCLUDE"] === 0 && item["СТРЕЛКА"] === 0 && item["СТЕПЕНЬ"] === 4 && item["ОТСТУПЛЕНИЕ"] !== "Кривая" && item["ОТСТУПЛЕНИЕ"] !== "ПрУ") {
                fourthDegrees.push({
                    "EXCLUDE": item["EXCLUDE"],
                    "KM": item["KM"],
                    "PR_PREDUPR": item["PR_PREDUPR"],
