const DB = {
    ...
    distances: [
      ...
      {distanceNumber: 3, distanceName: "Ростовская дистанция пути", regionNumber: 1, regionTitle: "Ростовский"},
      {distanceNumber: 4, distanceName: "Батайская дистанция пути", regionNumber: 1, regionTitle: "Ростовский"},
      {distanceNumber: 6, distanceName: "Тихорецкая дистанция пути", regionNumber: 2, regionTitle: "Краснодарский", regionTitle: "Краснодарский"},
      {distanceNumber: 7, distanceName: "Кавказская дистанция пути", regionNumber: 2, regionTitle: "Краснодарский"},
      {distanceNumber: 8, distanceName: "Армавирская дистанция пути", regionNumber: 6, regionTitle: "Туапсинский", regionTitle: "Туапсинский"},
      {distanceNumber: 10, distanceName: "Минераловодская дистанция пути", regionNumber: 3, regionTitle: "Минераловодский", regionTitle: "Минераловодский"},
      {distanceNumber: 12, distanceName: "Прохладненская дистанция пути", regionNumber: 3, regionTitle: "Минераловодский"},
      {distanceNumber: 15, distanceName: "Гудермесская дистанция пути", regionNumber: 5, regionTitle: "Грозненский"},
      {distanceNumber: 16, distanceName: "Махачкалинская дистанция пути", regionNumber: 4, regionTitle: "Махачкалинский"},
      {distanceNumber: 18, distanceName: "Белореченская дистанция пути", regionNumber: 6, regionTitle: "Туапсинский"},
      {distanceNumber: 19, distanceName: "Туапсинская дистанция пути", regionNumber: 6, regionTitle: "Туапсинский"},
      {distanceNumber: 20, distanceName: "Сочинская дистанция инфраструктуры", regionNumber: 6, regionTitle: "Туапсинский"},
      {distanceNumber: 21, distanceName: "Краснодарская дистанция пути", regionNumber: 2, regionTitle: "Краснодарский"},
      {distanceNumber: 22, distanceName: "Новороссийская дистанция пути", regionNumber: 2, regionTitle: "Краснодарский"},
      {distanceNumber: 23, distanceName: "Старотиторовская дистанция пути", regionNumber: 2, regionTitle: "Краснодарский"},
      {distanceNumber: 24, distanceName: "Тимашевская дистанция пути", regionNumber: 2, regionTitle: "Краснодарский"},
      {distanceNumber: 26, distanceName: "Сальская дистанция пути", regionNumber: 1, regionTitle: "Ростовский"},
      {distanceNumber: 27, distanceName: "Куберлевская дистанция пути", regionNumber: 1, regionTitle: "Ростовский"},
      {distanceNumber: 30, distanceName: "Кизлярская дистанция пути", regionNumber: 4, regionTitle: "Махачкалинский"},
      {distanceNumber: 32, distanceName: "Горячеключевская дистанция пути", regionNumber: 6, regionTitle: "Туапсинский"},
      {distanceNumber: 33, distanceName: "Лиховская дистанция пути", regionNumber: 1, regionTitle: "Ростовский"},
      {distanceNumber: 35, distanceName: "Миллеровская дистанция пути", regionNumber: 1, regionTitle: "Ростовский"},
      {distanceNumber: 28, distanceName: "Ставропольская дистанция инфраструктуры", regionNumber: 3, regionTitle: "Минераловодский"},
      {distanceNumber: 29, distanceName: "Ставропольская дистанция инфраструктуры", regionNumber: 3, regionTitle: "Минераловодский"}
    ]
}
