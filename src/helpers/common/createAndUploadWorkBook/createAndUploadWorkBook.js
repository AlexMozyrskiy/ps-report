...
/*
    ...
    converterToAoA - функция колл бек пребразователь информации типа как в стейте в массив массивов. Передаем сюда именно ту функцию которая преобразовывает информацию в ту форму отчета которая нам нужна
    data - массив объектов - тип как в стейте,
    bookName - название создаваемой книги,
    sheetName - название создаваемого листа
*/

export function createAndUploadWorkBook(converterToAoA, data, bookName, sheetName) {
    ...
    const dataToWrite = converterToAoA(data);                           // массив массивов с информаций для записи в xlsx файл
